    ...
    <section className='Navbar-Section'style={{borderBottom:'1px solid #2d3139'}}>
      <div className="container">
        <div className="row col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
          <div className="BrandName col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-2">
          ...
          <div className="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-5 align-items-center justify-content-end d-flex">
